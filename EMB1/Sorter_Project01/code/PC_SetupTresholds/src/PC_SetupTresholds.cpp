...
//int t_red[6] = {	200, 	400, 	0, 	100,	0,	200};
//int t_green[6] = {	60, 	90, 	130, 	400, 	200, 	230};
//int t_blue[6] = {	0, 	85, 	0, 	130, 	300, 	400};

int t_red[6] = {	450, 	550, 	150, 	200,	330,	380};
int t_green[6] = {	120, 	180, 	280, 	320, 	400, 	450};
int t_blue[6] = {	120, 	180, 	200, 	250, 	580, 	650};
