...
%  behaviour box
\node[rectangle,draw,minimum width=11cm, minimum height=3cm, dashed, name=behaviour_box]  at (0,0) {};
\node[name=behaviour] at (-3.7,1.2) {Behaviours};

% Brain node 
\node[rectangle,draw,minimum width=3cm, minimum height=1cm, name=brain, above=of behaviour_box] at (0,0.6) {Brain};
...
\node[rectangle,draw,minimum width=1.5cm, minimum height=0.8cm, name=right] at (0,-0.5) {Right};
